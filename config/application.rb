...
module Faucet
    class Application < Rails::Application
        ...
        config.action_mailer.default_options = {from: 'test_flc_001@163.com'}
        config.action_mailer.smtp_settings = {
            address: 'smtp.163.com',  #FAUCETCONF.smtp['host'],
            port: 465,
            #domain: FAUCETCONF.default_url,
            user_name: 'test_flc_001@163.com', #FAUCETCONF.smtp['user_name'],
            password: 'liuwei743619', #FAUCETCONF.smtp['password'],
