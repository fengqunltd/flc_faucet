...
ActiveRecord::Schema.define(version: 1) do
  ...
  create_table "f_lc_accounts", force: :cascade do |t|
  ...
  add_index "f_lc_accounts", ["name"], name: "index_f_lc_accounts_on_key", unique: true, using: :btree
  add_index "f_lc_accounts", ["objectid"], name: "index_f_lc_accounts_on_objectid", unique: true, using: :btree
  add_index "f_lc_accounts", ["user_id"], name: "index_f_lc_accounts_on_user_id", using: :btree
