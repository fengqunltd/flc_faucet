class CreateOrigSchema < ActiveRecord::Migration
    ...
    def change
        ...
        create_table 'f_lc_accounts' do |t|
            t.integer 'user_id'
            t.string 'name'
            t.string 'objectid'
            t.string 'owner_key'
        ...
        add_index 'f_lc_accounts', ['name'], name: 'index_f_lc_accounts_on_key', unique: true
        add_index 'f_lc_accounts', ['objectid'], name: 'index_f_lc_accounts_on_objectid', unique: true
        add_index 'f_lc_accounts', ['user_id'], name: 'index_f_lc_accounts_on_user_id'
